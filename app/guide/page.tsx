...
function MockPhone({ children, label }: { children: React.ReactNode; label?: string }) {
  return (
    <div className="flex flex-col items-center gap-2 my-2">
      {label && <p className="text-[10px] font-black text-zinc-500 tracking-widest uppercase">{label}</p>}
  ...
  return (
    <div className="p-4 space-y-4">
      <div className="text-center pt-4 pb-2">
        <div className="text-3xl font-black italic text-white tracking-tighter">BLITZ <span className="text-emerald-500">BOARD</span></div>
  ...
  return (
    <div className="p-3 space-y-3">
      <div className="border-b border-emerald-500 pb-3 mb-3">
        <div className="text-2xl font-black italic text-white tracking-tighter">BLITZ <span className="text-emerald-500 text-lg">BOARD</span></div>
...
function MockPayouts() {
  return (
    <div className="p-3 space-y-3">
      <div className="text-center"><div className="text-white font-black text-sm italic">MATCH PAYOUTS</div></div>
      <div className="bg-zinc-950 rounded-2xl border border-zinc-800 overflow-hidden">
...
function MockWizard() {
  return (
    <div className="p-3 space-y-2">
      <div className="text-center mb-2"><div className="text-white font-black text-xs italic">TOURNAMENT WIZARD</div></div>
      {[
...
function MockWheel() {
  return (
    <div className="p-3 space-y-2">
      <div className="text-purple-400 font-black text-xs italic flex items-center gap-2"><RefreshCw size={12}/> WHEEL BET</div>
...
function MockResults() {
  return (
    <div className="p-3 space-y-2">
      <div className="text-white font-black text-xs italic mb-2">TOURNAMENT RESULTS</div>
...
function MockQuickMatch() {
  return (
    <div className="p-3 space-y-3">
      <div className="flex items-center gap-2 mb-1"><Zap size={14} className="text-amber-400"/><span className="text-amber-400 font-black text-xs italic">QUICK MATCH</span></div>
      ...
      <div className="text-white font-black text-sm italic">Players</div>
    ...
    <div className="bg-zinc-950 rounded-[2rem] border border-zinc-800 overflow-hidden">
      <button onClick={() => setOpen(!open)}
        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            <h2 className={`font-black text-xl uppercase italic ${color}`}>{title}</h2>
...
function FeatureCard({ icon, title, desc }: { icon: string; title: string; desc: string }) {
  return (
    <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-5 space-y-2">
      ...
      <div className="font-black text-sm text-white uppercase italic">{title}</div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            {[
              ...
              <div key={item.title} className="bg-zinc-900 border border-zinc-800 rounded-2xl p-5 space-y-2">
                <div className="text-2xl">{item.icon}</div>
                <div className="font-black text-sm text-white uppercase italic">{item.title}</div>
